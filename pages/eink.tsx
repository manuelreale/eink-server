  ...
  return (
    <>
      <Head>
        ...
        {/* Japanese-capable font so Kanji render correctly in headless Chrome */}
        <link
      ...
      <div className="root">
        <img src="/pages/img.png" className="w-full h-full absolute top-0 left-0 z-10" />
        <div className="page">
        ...
        <style jsx>{`
          .root {
            ...
            font-family: "Noto Sans JP", system-ui, -apple-system,
              BlinkMacSystemFont, "Helvetica", "Arial", "Yu Gothic",
